...
describe('WeatherComponent', () => {
  ...
  beforeEach(() => {
    ...
    injector = getTestBed();
    service = injector.get(WeatherAPIService);
  ...
  it('should return mockDATA', () => {
    ...
    const req = httpMock.expectOne(`https://api.openweathermap.org/data/2.5/forecast?q=Stockholm,se&units=metric&APPID=bc399329a40cf183523b1b5d4e8ed33b`);
